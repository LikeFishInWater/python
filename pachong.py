...
proxy_ips = [    '27.15.236.236'    ] # �滻�Լ��Ĵ���IP
headers = {
...
class LuooSpider(threading.Thread):
    ...
    def spider(self, vol):
        ...
        for track in track_names:
            _id = str(int(track.text[:2])) if (int(vol) < 12) else track.text[:2]  # 12��ǰ�����ֱ��1~9��1λ���磺1~9����֮��Ķ���2λ 1~9������ߵ�0���磺01~09��
            ...
            phases = {
                ...
                'title': title,                       # �ڿ�����
                 'cover': cover,                      # �ڿ�����
                 'desc': desc,                        # �ڿ�����
                 'track_count': track_count,          # ��Ŀ��
                 'tracks': tracks                     # ��Ŀ�嵥(��Ŀ��ţ���Ŀ����)
            }
